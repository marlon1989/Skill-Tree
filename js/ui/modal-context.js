...
class BossOption {
  ...
  toMarkup() {
    return `
      <button
        type="button"
        class="boss-option rounded-lg border border-white/10 bg-slate-950/70 px-4 py-3 text-left text-sm font-medium text-slate-100 transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-200/70 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 hover:border-cyan-200/40 hover:bg-cyan-200/10"
